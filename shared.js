...
const PHONE="+66 082 894 3665", PHONE_TEL="tel:+660828943665", LINE_ID="@370nwatk", LINE_DEEP="https://line.me/R/ti/p/@370nwatk", WA_URL="https://wa.me/660828943665", WA_QR="https://wa.me/qr/TH2MCJADMW2XI1", ADDR="Bangkok, Thailand", MAPS_URL="https://maps.app.goo.gl/rcKXQsdLzDWAYKzQA";
...
function injectContactWidgets(){
  ...
  overlay.innerHTML = `
    <div class="contact-modal">
      ...
      <h3>Contact Us</h3>
      <a href="https://line.me/R/ti/p/@370nwatk" class="cm-btn cm-line">
      ...
      <a href="weixin://dl/chat?JazzyBKK" class="cm-btn cm-wechat">
        <span class="cm-icon" style="background:rgba(7,193,96,.15)"><svg viewBox="0 0 24 24" width="20" height="20" fill="#07c160"><path d="M8.691 2.188C3.891 2.188 0 5.476 0 9.53c0 2.212 1.17 4.203 3.002 5.55a.59.59 0 01.213.665l-.39 1.48c-.019.07-.048.141-.048.213 0 .163.13.295.29.295a.326.326 0 00.167-.054l1.903-1.114a.864.864 0 01.717-.098 10.16 10.16 0 002.837.403c.276 0 .543-.027.811-.05-.857-2.578.157-4.972 1.932-6.446 1.703-1.415 3.882-1.98 5.853-1.838-.576-3.583-4.196-6.348-8.596-6.348zM5.785 5.991c.642 0 1.162.529 1.162 1.18a1.17 1.17 0 01-1.162 1.178A1.17 1.17 0 014.623 7.17c0-.651.52-1.18 1.162-1.18zm5.813 0c.642 0 1.162.529 1.162 1.18a1.17 1.17 0 01-1.162 1.178 1.17 1.17 0 01-1.162-1.178c0-.651.52-1.18 1.162-1.18zm3.348 2.867c-1.577-.073-3.146.456-4.326 1.515-1.489 1.332-2.192 3.323-1.697 5.363.468 1.927 2.118 3.453 4.168 4.064a9.26 9.26 0 002.787.43c.918 0 1.785-.18 2.577-.496a.71.71 0 01.592.082l1.562.912a.268.268 0 00.138.045c.131 0 .239-.108.239-.242 0-.06-.023-.118-.039-.175l-.32-1.211a.486.486 0 01.175-.544C21.978 18.48 23 16.82 23 14.98c0-3.21-3.062-5.853-6.943-6.112zm-2.023 2.74c.525 0 .951.433.951.966a.958.958 0 01-.951.966.958.958 0 01-.951-.966c0-.533.426-.966.951-.966zm4.762 0c.525 0 .951.433.951.966a.958.958 0 01-.951.966.958.958 0 01-.951-.966c0-.533.426-.966.951-.966z"/></svg></span>
      ...
      <a href="tel:+660828943665" class="cm-btn cm-call">
        <span class="cm-icon" style="background:rgba(232,195,100,.15)"><svg viewBox="0 0 24 24" width="20" height="20" fill="#e8c364"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg></span>
  ...
  bar.innerHTML = `
    <a href="tel:+660828943665" class="mbb-btn"><span class="mbb-icon"><svg viewBox="0 0 24 24" width="22" height="22" fill="#e8c364"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg></span><span class="mbb-label" data-i18n="btn.call">Call</span></a>
    <a href="https://line.me/R/ti/p/@370nwatk" class="mbb-btn"><span class="mbb-icon"><svg viewBox="0 0 24 24" width="22" height="22" fill="#06c755"><path d="M19.365 9.863c.349 0 .63.285.63.631 0 .345-.281.63-.63.63H17.61v1.125h1.755c.349 0 .63.283.63.63 0 .344-.281.629-.63.629h-2.386c-.345 0-.627-.285-.627-.629V8.108c0-.345.282-.63.627-.63h2.386c.349 0 .63.285.63.63 0 .349-.281.63-.63.63H17.61v1.125h1.755zm-3.855 3.016c0 .27-.174.51-.432.596-.064.021-.133.031-.199.031-.211 0-.391-.09-.51-.25l-2.443-3.317v2.94c0 .344-.279.629-.631.629-.346 0-.626-.285-.626-.629V8.108c0-.271.173-.508.43-.595.06-.023.136-.033.194-.033.195 0 .375.104.495.254l2.462 3.33V8.108c0-.345.282-.63.63-.63.345 0 .63.285.63.63v4.771zm-5.741 0c0 .344-.282.629-.631.629-.345 0-.627-.285-.627-.629V8.108c0-.345.282-.63.627-.63.349 0 .631.285.631.63v4.771zm-2.466.629H4.917c-.345 0-.63-.285-.63-.629V8.108c0-.345.285-.63.63-.63.348 0 .63.285.63.63v4.141h1.756c.348 0 .629.283.629.63 0 .344-.281.629-.629.629M24 10.314C24 4.943 18.615.572 12 .572S0 4.943 0 10.314c0 4.811 4.27 8.842 10.035 9.608.391.082.923.258 1.058.59.12.301.079.766.038 1.08l-.164 1.02c-.045.301-.24 1.186 1.049.645 1.291-.539 6.916-4.078 9.436-6.975C23.176 14.393 24 12.458 24 10.314"/></svg></span><span class="mbb-label">LINE</span></a>
    <a href="book.html" class="mbb-btn"><span class="mbb-icon"><svg viewBox="0 0 24 24" width="22" height="22" fill="#e8c364"><path d="M19 3h-1V1h-2v2H8V1H6v2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V8h14v11z"/></svg></span><span class="mbb-label" data-i18n="nav.book">Book</span></a>`;
